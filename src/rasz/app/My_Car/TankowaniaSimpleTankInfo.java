...
public class TankowaniaSimpleTankInfo {
	...
	public TankowaniaSimpleTankInfo() {
	}

	public TankowaniaSimpleTankInfo(int idTank, int idSamochoduZtankowania, double przebieg, double litry, double cenaLitra, double wartosc, String date,
	...
	public TankowaniaSimpleTankInfo(Cursor cc) {
