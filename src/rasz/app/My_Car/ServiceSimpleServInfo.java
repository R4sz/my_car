...
public class ServiceSimpleServInfo {
	...
	public ServiceSimpleServInfo() {
	}

	public ServiceSimpleServInfo(int idserv, int idsam, Double mileage, Double cost, String serviced, String date, String time, String place, String notes, Long datawmms) {
		super();
	...
	public ServiceSimpleServInfo(Cursor cc) {
